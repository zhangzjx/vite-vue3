	...
	<el-card>
		<div>
			...
			<article>
				<h2>简介</h2>
				<p>
					vue-admin-box是一个开源的中后台管理项目，主要技术栈为vue3全家桶，包括了：vue3(vue-next)、vite、element-plus、vue-router、vuex、axios、vite-plugin-mock等众多中后台项目常用技术。
				</p>
				<ol>
					...
					<li>
						vite-plugin-mock：本地和线上mock数据专用库，本地可查看到真实http请求，线上使用js版本来做替换
					</li>
				</ol>
				<h2>关于crud的优化</h2>
				<p>
